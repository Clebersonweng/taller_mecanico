class MechanicsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @mechanic.save
        ...
        format.json { render :index, status: :created, location: @mechanic }
      else
  ...
  def update
    respond_to do |format|
      if @mechanic.update(mechanic_params)
        ...
        format.json { render :index, status: :ok, location: @mechanic }
      else
  ...
  private
    ...
    def mechanic_params
      params.require(:mechanic).permit(:document, :name, :lastname, :address, :phone)
    end
end
